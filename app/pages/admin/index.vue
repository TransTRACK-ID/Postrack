...
const adminPageBindings = {
  ...
  sidebarListeners: {
    ...
    shareCollection: openShareCollection,
  ...
  <div class="flex flex-col flex-1 min-h-0 overflow-hidden">
        ...
        <div v-show="hasWorkspaces && activeAdminPanel === 'environments'" class="h-full flex flex-col p-6 overflow-hidden">
          ...
          <EnvironmentManager
            ...
            @rename="openEnvironmentRenameModal"
            @duplicate="openEnvironmentDuplicateModal"
            @delete="openEnvironmentDeleteModal"
        ...
        <div v-if="openTabs.length > 0" v-show="activeAdminPanel === 'requests' && !selectedMock" class="flex flex-col flex-1 overflow-hidden">
          ...
          <div v-if="selectedRequest && activeTabKey" class="flex-1 flex flex-col md:flex-row overflow-hidden min-h-0">
            ...
            <div class="flex flex-col md:flex-row items-stretch flex-shrink-0 min-h-0 h-full border-t md:border-t-0 md:border-l border-border-default">
              ...
              >
                <div 
                  v-if="showCodeExamples"
                  class="code-panel bg-bg-sidebar flex flex-col flex-shrink-0 overflow-hidden min-h-0 h-full w-full md:w-auto"
                >
